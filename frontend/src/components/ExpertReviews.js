...
const getImageUrl = (imagePath) => {
  if (!imagePath) return "/assets/products/default.png"; // fallback
        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h3 className="font-semibold text-left text-lg">{product.ProductName}</h3>
            ...
            <span className="text-lg">{expandedId === product.ProductID ? "▲" : "▼"}</span>
          </button>
